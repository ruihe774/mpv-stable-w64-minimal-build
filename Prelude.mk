...
SUB_CONFIGURE = cd $(PKG_SRC) && ./configure --host=$(HOST) --prefix=$(PREFIX) CFLAGS=-O3 CXXFLAGS=-O3
SUB_MESON = meson --prefix=$(PREFIX) --buildtype=release -Dc_args=-I$(INCLUDE) -Dc_link_args=-L$(LIB) -Dcpp_args=-I$(INCLUDE) -Dcpp_link_args=-L$(LIB) -Dcpp_rtti=false --cross-file=$(MESON_CROSS) $(MESON_OPTIONS) $(PKG_BUILD) $(PKG_SRC)
